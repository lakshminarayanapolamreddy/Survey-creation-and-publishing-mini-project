...
echo"<form method = 'post' action = 'responses.php'>";
 while ($row = mysqli_fetch_assoc($result)) {
	...
	elseif($questionText ==='Is the given time to complete your project is sufficient?'){
		...
		echo"<input type = 'radio' name = 'ans'>Yes<br>";
		echo"<input type = 'radio' name = 'ans'>No<br>";
	}elseif($questionText ==='If you need any extra time, How many days do you need?(0 days if NO)'){
		echo"<label>$questionText</label><br>";
		echo"<input type = 'text' name = 'ans' required / ><br>";
	}elseif($questionText ==='Have you encountered any difficulties in doing the project?'){
		echo"<label>$questionText</label><br>";
		echo"<input type = 'radio' name = 'ans'>Yes<br>";
		echo"<input type = 'radio' name = 'ans'>No<br>";
	}elseif($questionText ==='If  yes, What are the difficulties you encountered?'){
		echo"<label>$questionText</label><br>";
		echo"<input type = 'text' name = 'ans' required / ><br>";	
	}elseif($questionText ==='Did your mentor make you to overcome the difficulties?'){
		echo"<label>$questionText</label><br>";
		echo"<input type = 'radio' name = 'ans'>Yes<br>";
		echo"<input type = 'radio' name = 'ans'>No<br>";
	}
